...
HD_PWD='C:/Users/Andrei/Documents/PSN/LANT_INV/LANT_INV.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LANT.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LANT.tcl
