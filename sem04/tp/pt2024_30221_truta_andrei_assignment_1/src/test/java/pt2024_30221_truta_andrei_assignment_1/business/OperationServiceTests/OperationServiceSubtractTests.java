...
public class OperationServiceSubtractTests {
    @Test
    public void HavingTwoPolynomials_WhenOneIsNull_ThrowsException() {
        ...
        assertThrows(IllegalArgumentException.class, () -> operationService.subtractPolynomials(polynomial1, polynomial2));
    }
    ...
    public void HavingTwoPolynomials_WhenBothAreNotNull_ReturnsResult() {
        ...
        Polynomial result = operationService.subtractPolynomials(polynomial1, polynomial2);
