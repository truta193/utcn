...
var $author$project$Exercises$changePreferenceToDarkTheme = function (accounts) {
	return _Debug_todo(
		'Exercises',
		{
...
var $author$project$Exercises$usersWithPhoneNumbers = function (users) {
	return _Debug_todo(
		'Exercises',
		{
...
var $author$project$ExerciseTests$suite = A2(
				...
				[
					...
					function (_v0) {
						...
						return A2(
							...
							$author$project$Exercises$usersWithPhoneNumbers(
								_List_fromArray(
									[user1, user2, user3])));
					})
				])),
				...
				[
					...
					function (_v1) {
						...
						return A2(
							...
							$author$project$Exercises$changePreferenceToDarkTheme(
								_List_fromArray(
...
var $author$project$Test$Generated$Main$main = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$author$project$Test$Runner$Node$check($author$project$ExerciseTests$suite)
				]))
		]));
