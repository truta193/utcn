...
var $author$project$Documentation$combinations = function (l) {
	if (!l.b) {
		...
		var x = l.a;
		var xs = l.b;
		var withoutX = $author$project$Documentation$combinations(xs);
		var withX = A2(
			$elm$core$List$map,
			function (combo) {
				return A2($elm$core$List$cons, x, combo);
			},
			withoutX);
		return _Utils_ap(withX, withoutX);
	}
};
...
var $author$project$Test$Generated$Main$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		...
		paths: _List_fromArray(
			['C:\\Users\\Andrei\\Documents\\2024-2025\\PF\\Lab07\\tests\\VerifyExamples\\Documentation\\Combinations0.elm', 'C:\\Users\\Andrei\\Documents\\2024-2025\\PF\\Lab07\\tests\\VerifyExamples\\Documentation\\Combinations1.elm', 'C:\\Users\\Andrei\\Documents\\2024-2025\\PF\\Lab07\\tests\\VerifyExamples\\Documentation\\Tails0.elm']),
		processes: 12,
...
var pipeFilename = "\\\\.\\pipe\\elm_test-4904-1";
var net = require('net'),
