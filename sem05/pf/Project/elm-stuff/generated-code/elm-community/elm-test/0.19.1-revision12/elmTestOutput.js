	...
	if (!right.b) {
		...
		return $elm$core$Maybe$Just(
			A3(
				...
				A2($elm$core$List$cons, element, left),
				next,
				tail));
	}
};
	...
	function (change, config) {
		switch (change.$) {
			...
			default:
				return _Utils_update(
					config,
					{showTextOnly: !config.showTextOnly});
		}
	});
		...
		if (!ids.b) {
			...
			return $elm$core$Maybe$Just(
				$author$project$Model$PostIds$PostIds(
					A2($author$project$Cursor$nonEmpty, head, tail)));
		}
	},
...
var $author$project$Util$Time$durationBetween = F2(
	function (t1, t2) {
		...
		var diffMillis = millis2 - millis1;
		if (diffMillis < 0) {
			return $elm$core$Maybe$Nothing;
		} else {
			var seconds = (diffMillis / 1000) | 0;
			var remainingSeconds = A2($elm$core$Basics$modBy, 60, seconds);
			var minutes = (seconds / 60) | 0;
			var remainingMinutes = A2($elm$core$Basics$modBy, 60, minutes);
			var hours = (minutes / 60) | 0;
			var remainingHours = A2($elm$core$Basics$modBy, 24, hours);
			var days = (hours / 24) | 0;
			return $elm$core$Maybe$Just(
				{days: days, hours: remainingHours, minutes: remainingMinutes, seconds: remainingSeconds});
		}
	});
...
var $author$project$Model$PostsConfig$filterPosts = F2(
	function (config, posts) {
		var sortPosts = function (lst) {
			return _Utils_eq(config.sortBy, $author$project$Model$PostsConfig$None) ? lst : A2(
				$elm$core$List$sortWith,
				$author$project$Model$PostsConfig$sortToCompareFn(config.sortBy),
				lst);
		};
		var limitPosts = function (lst) {
			return A2($elm$core$List$take, config.postsToShow, lst);
		};
		var filterByTextOnly = function (lst) {
			return config.showTextOnly ? lst : A2(
		...
		var filterByJobs = function (lst) {
			return config.showJobs ? lst : A2(
				$elm$core$List$filter,
				function (post) {
...
var $author$project$Util$Time$formatDuration = function (duration) {
	var units = A2(
		...
		_List_fromArray(
			[
				_Utils_Tuple2(duration.days, 'day'),
				_Utils_Tuple2(duration.hours, 'hour'),
				_Utils_Tuple2(duration.minutes, 'minute'),
				_Utils_Tuple2(duration.seconds, 'second')
			]));
	var formatUnit = F2(
		function (value, singular) {
			return $elm$core$String$fromInt(value) + (' ' + (singular + ((value === 1) ? '' : 's')));
		});
	var formattedUnits = function () {
		if (!units.b) {
			return '0 seconds';
		} else {
			if (!units.b.b) {
				...
				var value1 = _v1.a;
				var label1 = _v1.b;
				return A2(formatUnit, value1, label1);
			} else {
				var _v2 = units.a;
				var value1 = _v2.a;
				var label1 = _v2.b;
				...
				var value2 = _v4.a;
				var label2 = _v4.b;
				return A2(formatUnit, value1, label1) + (' ' + A2(formatUnit, value2, label2));
			}
		}
	}();
...
var $author$project$View$Posts$postTable = F3(
	function (config, currentTime, posts) {
					...
					[
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$text(' (' + (duration + ' ago)'))
							])),
						A2(
						$elm$html$Html$td,
						_List_fromArray(
						...
						_List_fromArray(
							[
								...
								if (_v0.$ === 'Just') {
									...
									return $elm$html$Html$text('No link');
								}
							}()
							]))
					]));
		...
		var filteredPosts = A2($author$project$Model$PostsConfig$filterPosts, config, posts);
		return A2(
			$elm$html$Html$table,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('posts-table'),
			...
			_List_fromArray(
				[
					...
					$elm$html$Html$tbody,
					_List_Nil,
					A2($elm$core$List$map, postRow, filteredPosts))
				]));
	});
...
var $author$project$Model$PostsConfig$ToggleShowJobs = {$: 'ToggleShowJobs'};
var $author$project$Model$PostsConfig$ToggleShowTextOnly = {$: 'ToggleShowTextOnly'};
...
var $author$project$View$Posts$postsConfigView = function (config) {
	var handleSortChange = function (sortStr) {
		var _v3 = $author$project$Model$PostsConfig$sortFromString(sortStr);
		if (_v3.$ === 'Just') {
			var sortBy = _v3.a;
			return $author$project$Model$ConfigChanged(
				$author$project$Model$PostsConfig$ChangeSortBy(sortBy));
		} else {
			return $author$project$Model$ConfigChanged(
				$author$project$Model$PostsConfig$ChangeSortBy($author$project$Model$PostsConfig$defaultConfig.sortBy));
		}
	};
	var handleShowTextPosts = function (_v2) {
		return $author$project$Model$ConfigChanged($author$project$Model$PostsConfig$ToggleShowTextOnly);
	};
	var handleShowJobPosts = function (_v1) {
		return $author$project$Model$ConfigChanged($author$project$Model$PostsConfig$ToggleShowJobs);
	};
	var handlePerPageChange = function (perPageStr) {
		var _v0 = $elm$core$String$toInt(perPageStr);
		if (_v0.$ === 'Just') {
			var value = _v0.a;
			return $author$project$Model$ConfigChanged(
				$author$project$Model$PostsConfig$ChangePostsToShow(value));
		} else {
			return $author$project$Model$ConfigChanged(
				$author$project$Model$PostsConfig$ChangePostsToShow($author$project$Model$PostsConfig$defaultConfig.postsToShow));
		}
	};
	var defaultSelectedSortBy = config.sortBy;
	var defaultPerPage = config.postsToShow;
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Events$onInput(handlePerPageChange)
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Attributes$selected(defaultPerPage === 10)
							]),
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Attributes$selected(defaultPerPage === 25)
							]),
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Attributes$selected(defaultPerPage === 50)
							]),
						_List_fromArray(
							[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Events$onInput(handleSortChange)
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								...
								$author$project$Model$PostsConfig$sortToString($author$project$Model$PostsConfig$None)),
								$elm$html$Html$Attributes$selected(
								_Utils_eq(defaultSelectedSortBy, $author$project$Model$PostsConfig$None))
							]),
						_List_fromArray(
							[
								$elm$html$Html$text(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$value(
								$author$project$Model$PostsConfig$sortToString($author$project$Model$PostsConfig$Score)),
								$elm$html$Html$Attributes$selected(
								_Utils_eq(defaultSelectedSortBy, $author$project$Model$PostsConfig$Score))
							]),
						_List_fromArray(
							[
								$elm$html$Html$text(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$value(
								$author$project$Model$PostsConfig$sortToString($author$project$Model$PostsConfig$Title)),
								$elm$html$Html$Attributes$selected(
								_Utils_eq(defaultSelectedSortBy, $author$project$Model$PostsConfig$Title))
							]),
						_List_fromArray(
							[
								$elm$html$Html$text(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$value(
								$author$project$Model$PostsConfig$sortToString($author$project$Model$PostsConfig$Posted)),
								$elm$html$Html$Attributes$selected(
								_Utils_eq(defaultSelectedSortBy, $author$project$Model$PostsConfig$Posted))
							]),
						_List_fromArray(
							[
								$elm$html$Html$text(
					...
					[
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Events$onCheck(handleShowJobPosts)
							]),
						_List_Nil),
					...
					[
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Events$onCheck(handleShowTextPosts)
							]),
						_List_Nil),
						$elm$html$Html$text('Show text posts')
					]))
			]));
};
	...
	if (!left.b) {
		...
		return $elm$core$Maybe$Just(
			A3(
				...
				tail,
				first,
				A2($elm$core$List$cons, element, right)));
	}
};
var $author$project$Cursor$fromList = function (l) {
	if (!l.b) {
		...
		var tail = l.b;
		return $elm$core$Maybe$Just(
			A3($author$project$Cursor$Cursor, _List_Nil, first, tail));
	}
};
...
var $author$project$Test$Generated$Main$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		...
		paths: _List_fromArray(
			['C:\\Users\\Andrei\\Documents\\2024-2025\\PF\\Project\\tests\\ExampleTests\\CursorTests.elm', 'C:\\Users\\Andrei\\Documents\\2024-2025\\PF\\Project\\tests\\ExampleTests\\ModelPostIdsTests.elm', 'C:\\Users\\Andrei\\Documents\\2024-2025\\PF\\Project\\tests\\ExampleTests\\ModelPostsConfigTests.elm', 'C:\\Users\\Andrei\\Documents\\2024-2025\\PF\\Project\\tests\\ExampleTests\\UtilTimeTests.elm', 'C:\\Users\\Andrei\\Documents\\2024-2025\\PF\\Project\\tests\\MainTests.elm', 'C:\\Users\\Andrei\\Documents\\2024-2025\\PF\\Project\\tests\\PostsConfigTests.elm', 'C:\\Users\\Andrei\\Documents\\2024-2025\\PF\\Project\\tests\\PostsViewTests.elm', 'C:\\Users\\Andrei\\Documents\\2024-2025\\PF\\Project\\tests\\PostTests.elm', 'C:\\Users\\Andrei\\Documents\\2024-2025\\PF\\Project\\tests\\SimulatedEffect.elm', 'C:\\Users\\Andrei\\Documents\\2024-2025\\PF\\Project\\tests\\TestData.elm', 'C:\\Users\\Andrei\\Documents\\2024-2025\\PF\\Project\\tests\\TestUtils.elm']),
		processes: 12,
...
var pipeFilename = "\\\\.\\pipe\\elm_test-12296-1";
var net = require('net'),
